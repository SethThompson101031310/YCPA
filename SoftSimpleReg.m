% Code seems to be simulating the electric field component of an EM 
% wave traveling through a semiconductor device.
...
% Creating another inclusion
epi{1}(55:95,90:125)= c_eps_0*11.3;
% Creating another inclusion
epi{1}(55:95,35:60)= c_eps_0*11.3;
